...
public class PictureMasterViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    @objc public func tapGesture(_ gesture: UITapGestureRecognizer) {
        guard let view = gesture.view else { return }
        self.resetViewFrameAndRotation(view, animated: true, completion: nil)
    }
    
    @objc public func pinchGesture(_ gesture: UIPinchGestureRecognizer) {
        guard let view = gesture.view else { return }
    ...
    @objc func tapBackgroundGesture(_ gesture: UITapGestureRecognizer) {
        self.dismiss(animated: false, completion: nil)
    }

    @objc func swipeOutGesture(_ gesture: UITapGestureRecognizer) {
        guard let view = gesture.view else { return }
